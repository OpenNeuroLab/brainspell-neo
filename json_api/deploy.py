...
class DeployHandler(BaseHandler):
    def get(self):
        ...
        if port_to_run == 5858:
            ...
            print("Debug server: Navigating into the parent directory, and pulling from the git repo.")
            subprocess_cmd_sync("cd ../../; git pull origin master; python3 json_api/brainspell.py")
            ...
            subprocess_cmd_async("cd debug/brainspell-neo; python3 json_api/brainspell.py -p 5858 &")
            sleep(.5)
