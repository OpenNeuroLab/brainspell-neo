...
driver = webdriver.Remote(browser_profile=selenium.webdriver.firefox.firefox_profile.FirefoxProfile,desired_capabilities=capabilities, command_executor="http://%s/wd/hub" % hub_url)
